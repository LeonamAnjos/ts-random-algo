import {JSONObject, jsonToCamelCase, snakeCaseToCamelCase} from "../../src/strings/json-to-camel-case";
...
describe(".snakeCaseToCamelCase()", () => {
    [
        ...
        it(`WHEN ${input}`, () => expect(snakeCaseToCamelCase(input)).toBe(expected));
    });
});
